      ...
      <div className={styles.root}>
        ...
        <main className="__relative __how-to-play-page">
          ...
          <section className={styles.contectSection}>
            <div>
              <p className={styles.blogSection1}>
                Go to the <Link to="/">Power Center</Link> and browse available
                games, click ‘Enter’.
              </p>
            </div>
          ...
          <section className={styles.contectSection}>
            <div>
              <p className={styles.blogSection3}>
                ...
                <Link to="/">Team Manager</Link> to launch the live Team Manager
                page.
              </p>
            </div>
            <Animate>
          ...
          <section className={styles.contectSection4}>
            <p>
              {" "}
              <Link to="/">Team Manager</Link> page overview – this is where you
              can see your entire team in one view, see you current standings,
              and see how many powers you have remaining.
            </p>
            <Animate>
              <img alt="" src={img4} />
            </Animate>

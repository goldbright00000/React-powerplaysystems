  ...
  return (
    <div className={classes.__account_limits}>
      <div className={classes.__main_description}>
        <p>
          Setting a personal user limit is a tool that can assist in managing
          your play in a healthy and responsible way. You can change your limits
          at any time but there'll be a 90 day restriction before you can
          increase your limit afterwards.
        </p>
        <p>
          Below you have the option to limit yourself in a variety of ways to
          make sure that you are spending your time on PowerPlay appropriately.
        </p>
      </div>
      <div className={classes.__main_title}>Deposit Limits and Alerts</div>
      ...
      <div className={classes.__main_title}>Entry Fee Limit</div>
      <div className={classes.__entry_fee_limit}>
        <div className={classes.__info}>
          Setting an entry fee limit prevents you from joining a contest that
          has an entry fee exceeding the limit you establish. Once you have set
          an limit you will be restricted from increasing your limit for 90
          calendar days.
        </div>
        <div className={classes.__input_field}>
          <div>

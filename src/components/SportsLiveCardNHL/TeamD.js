...
import RenderMLBPlayerStats from "../SportsLiveCardNHL/RenderMLBPlayerStats";
import SportsLiveCardFooter from "../SportsLiveCardNHL/SportsLiveCardFooter";
import VideoIcon from "../../icons/VideoIcon";
import ShieldIcon from "../../icons/ShieldIcon";
import Challenge from "../../icons/Challenge";
import { isEmpty } from "lodash";
import RenderPointsSummary from "../SportsLiveCardNHL/RenderPointsSummary";
import SportsLiveCardOverlay from "../SportsLiveCard/SportsLiveCardOverlay";
import { CardType } from "../SportsLiveCardNHL/CardType";
  ...
  const RenderHeader = () => (
    <div className={classes.card_header}>
      <p className={classes.card_header_title}>
        ...
        <span>
          Team D: <span className={classes.card_header_points}>-12 Pts</span>
        </span>
      </p>
